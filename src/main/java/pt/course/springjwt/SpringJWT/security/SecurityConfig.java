...
import pt.course.springjwt.SpringJWT.filter.CustomAuthorizationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http)throws  Exception{
        ...
        //overriding the default api for login form spring. to add api before
...
//        http.authorizeRequests().anyRequest().permitAll()
        ...
        http.authorizeRequests().antMatchers(GET, "apix/user/**").hasAnyAuthority("ROLE_USER");
